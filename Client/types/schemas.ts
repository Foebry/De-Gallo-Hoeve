...
const register = object({
    ...
    honden: array(
        object({
            ...
            geboortedatum: date().required({geboortedatum: "Geboortedatum is required"}),
...
export const schemas = {login, register, inschrijving, boeking};

export const { login: loginSchema, register: registerSchema, inschrijving: inschrijvingSchema, boeking: boekingSchema} = schemas;
