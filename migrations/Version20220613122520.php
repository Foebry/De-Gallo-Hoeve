 ...
 */
final class Version20220613122520 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE boeking CHANGE klant_id klant_id_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE boeking CHANGE klant_id_id klant_id INT NOT NULL');
