        ...
        <section className="bg-white pb-2 mx-auto md:px-5">
          <div className="px-5 mx-auto  max-w-7xl md:px-0">
            ...
            <div className="text-center flex flex-col gap-3">
              ...
              <Body>
                Heb je zelf geen tijd om elke zondag ochtend naar de
                hondenschool te gaan? <br />
              ...
              <ul className="mx-auto text-left pl-20 pt-2 pb-3 flex flex-col gap-1 md:w-4/5 md:pl-80">
                ...
                <li className="flex gap-1 items-center">
                  <GiCheckMark />
                  Of wil je gaag werken in de bewaking sector (afhankelijk van
                  het ras), Politie, Defensie?
                </li>
                <li className="flex gap-1 items-center">
                  <GiCheckMark />
